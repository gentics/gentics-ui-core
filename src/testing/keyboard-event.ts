...
/**
 * Cross-browser function for creating keyboard events with specific properties such as keyCode etc.
 * Taken from https://gist.github.com/termi/4654819
 */
...
let global = window
    , _initKeyboardEvent_type = (function(e: any) {
        try {
            e.initKeyboardEvent(
    ...
    , _Object_defineProperty = Object.defineProperty || function(obj: any, prop: any, val: any) {
            if( "value" in val ) {
                obj[prop] = val["value"];
            }
        }
...
export function crossBrowserInitKeyboardEvent(type: 'keydown' | 'keyup' | 'keypress', dict: KeyboardEventConfig): KeyboardEvent {
    var e: any;
